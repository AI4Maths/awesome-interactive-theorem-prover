...
- [F*](https://github.com/FStarLang/FStar) ![](https://img.shields.io/github/stars/FStarLang/FStar.svg?cacheSeconds=86400) - Verification-oriented programming language developed by Microsoft Research with support for effectful programs and SMT-based automation.
- [HOL4](https://github.com/HOL-Theorem-Prover/HOL) ![](https://img.shields.io/github/stars/HOL-Theorem-Prover/HOL.svg?cacheSeconds=86400) - Interactive theorem prover for higher-order logic (HOL4) with strong support for formalized mathematics, semantics, and verified systems.
- [HOL Light](https://github.com/jrh13/hol-light) ![](https://img.shields.io/github/stars/jrh13/hol-light.svg?cacheSeconds=86400) - Interactive theorem prover for higher-order logic developed by John Harrison, known for lightweight design and foundational formalization work.
...
Contributions are welcome! Please feel free to submit a pull request to add more interactive theorem provers to this awesome list.
