...
- [HOL](https://github.com/HOL-Theorem-Prover/HOL) ![](https://img.shields.io/github/stars/HOL-Theorem-Prover/HOL.svg?cacheSeconds=86400) - Interactive theorem prover for higher-order logic (HOL4) with strong support for formalized mathematics, semantics, and verified systems.
